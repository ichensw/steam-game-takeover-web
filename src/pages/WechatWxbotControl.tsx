...
const configSections: SectionDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'vector_qdrant_api_key', label: 'Qdrant API Key', type: 'password', wide: true },
      { key: 'vector_embedding_base_url', label: 'Embedding API Base URL', type: 'string', wide: true },
      { key: 'vector_embedding_api_key', label: 'Embedding API Key', type: 'password', wide: true },
...
export function validateWxbotConfig(config: WxbotRemoteConfig) {
  ...
  if (config.ai?.vector_enabled) {
    checks.push(
      ...
      () => requireText(config.ai, 'vector_qdrant_api_key', 'Qdrant API Key'),
      () => requireText(config.ai, 'vector_embedding_base_url', 'Embedding API Base URL'),
      () => requireText(config.ai, 'vector_embedding_api_key', 'Embedding API Key'),
